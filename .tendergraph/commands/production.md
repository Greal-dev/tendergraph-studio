---
name: production
description: Production du mémoire technique et livrables finaux
phase_backend: production
---

# Phase 7 — production

Invoque mt-writer. Produit 7-proposition/memoire-technique.md + valide via validate_plan.

## Protocole

1. Vérifie la phase courante via `tendergraph_step(action="status")`.
2. Si la phase courante n'est pas `production`, avertis l'user :
   *"Le pipeline est actuellement en phase X, cette commande s'applique à production.
