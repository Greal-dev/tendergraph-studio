---
name: comprehension-besoin
description: Phase 1 du pipeline Besoin→Devis — compréhension du besoin exprimé.
phase_backend: comprehension_besoin
---

# Devis — Phase 1 : compréhension du besoin
...
2. Si la phase courante n'est pas `comprehension_besoin`, avertis l'user (cette
